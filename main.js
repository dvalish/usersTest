...
var PostDetailsComponent = /** @class */ (function () {
    function PostDetailsComponent(data, route) {
        var _this = this;
        this.data = data;
        this.route = route;
...
module.exports = "<h1>Posts</h1>\n\n<ul>\n  <li *ngFor=\"let post of posts$\">\n    <a routerLink=\"/post-details/{{ post.id }}\">{{ post.title }}</a>\n  </li>\n</ul>\n"
...
module.exports = __webpack_require__(/*! /Users/bach/MyProjects/Angular Lessons/users/src/main.ts */"./src/main.ts");
